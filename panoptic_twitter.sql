...
--
-- Host: localhost:3306
-- Generation Time: Nov 28, 2017 at 06:16 PM
...
--
ALTER TABLE `crypto_mentions`
  MODIFY `mentionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1515;
--
-- AUTO_INCREMENT for table `crypto_users`
--
ALTER TABLE `crypto_users`
  MODIFY `userID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3406;
